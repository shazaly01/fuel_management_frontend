          ...
          <tr>
            <th class="p-0 align-top" :colspan="8">
              ...
              <div class="grid grid-cols-12 gap-x-4 mb-4 pb-4 border-b-2 border-gray-300">
                ...
                >
                  <p>
                    يتحمل السائق كامل المسؤولية القانونية والعملية عن حمولة الشاحنة اعتباراً من لحظة
                    مغادرته المستودع، ويلتزم بالمحافظة عليها وضمان سلامتها حتى تسليمها في موقع
                    التفريغ المذكور أدناه، دون أي إعفاء من المسؤولية تحت أي ظرف.
                  </p>
                </div>
              </div>
